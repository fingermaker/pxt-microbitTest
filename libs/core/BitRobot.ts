...
namespace BitRobot {
    ...
    */
    //% weight=2 blockGap=8
    //% blockId="neopixel_colors" block="获取颜色值 %color"
    //% advanced=true
    ...
    /**
      ...
      * @param rgb RGB color of the LED
      */
    //% blockId="bitbot_neo_set_color" block="设置LED颜色为 %rgb=neopixel_colors"
    //% weight=4
     ...
     * @param rgb RGB color of the LED
     */
    //% blockId="bitbot_neo_set_pixel_color" block="设置LED编号 %offset|的颜色 %rgb=neopixel_colors"
    //% weight=3
     ...
     * @param brightness a measure of LED brightness in 0-255. eg: 255
     */
    //% blockId="bitbot_neo_brightness" block="设置LED功率 %brightness"
    //% weight=10
